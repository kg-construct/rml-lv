...
- at least one field property (`rml:field`), whose value is an [=expression field=] (`rml:Field`). This field SHOULD only contain [=field references=] that can be evaluated on the parent logical view. 
