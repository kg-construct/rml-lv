## Logical view reference formulation {#logicalviewreferenceformulation}

The <a data-cite="RML-Core##dfn-reference-formulation">reference formulation</a> (`rml:referenceFormulation`) of a [=logical view=] is implicitly and by default defined. 
...
A [=record keys=] of an [=iterable field=] can not be referenced. 
